...
def empty_rag_result(message: str) -> dict:
    """Return a uniform error dict for all RAG_KEYS."""
...
def get_document_answer(
    ...
    """
    Run the RAG pipeline: retrieve context, build prompt, call AI, return result.

    Always returns a dict with all RAG_KEYS so the template never KeyErrors.
    """
    # --- validate inputs ------------------------------------------------
